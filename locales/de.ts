export default {
  ...
  'agitate.option1.title': 'Selbst machen?',
  'agitate.option1.description': 'Sie sind Geschäftsführer, kein Programmierer. Verschwenden Sie keine Zeit mit YouTube-Tutorials.',
  'agitate.option2.title': 'Jemanden einstellen?',
  'agitate.option2.description1': 'Gute KI-Experten kosten 100.000 € im Jahr. Unsere Systeme kosten einen Bruchteil.',
  'agitate.option2.description2': '',
  'agitate.option2.description3': '',
  'agitate.option3.title': 'Später anfangen?',
  'agitate.option3.description1': 'Ihre Konkurrenz automatisiert heute. Wer wartet, verliert Kunden.',
  'agitate.option3.description2': '',
  'agitate.option3.description3': '',

  // Solution Section
  'solution.title': 'Warum wir? Praxis-Erfahrung statt KI-Theorie.',
  'solution.card1.title': '8 Jahre Vertriebs-Expertise',
  'solution.card1.description': 'Wir wissen, wie Verkauf funktioniert. KI ist für uns kein Spielzeug, sondern der Turbo für Ihren Umsatz.',
  'solution.card2.title': 'Erprobte Systeme',
  'solution.card2.description': 'Seit 2 Jahren realisieren wir KI-Projekte für diverse Kunden. Wir implementieren nur, was stabil läuft und messbar Zeit spart.',
  'solution.card3.title': 'Unser Risiko',
  'solution.card3.description': 'Kommt kein Ergebnis zustande, erhalten Sie 50% des Honorars zurück. Punkt.',
